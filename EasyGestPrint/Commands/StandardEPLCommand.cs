...
namespace EasyGest.Print.Commands
{
    public partial class EPLCommands
    {
        ...
        public static byte[] EPL_Align(PrinterSettings p)
        {
            ...
            res.AddRange(EPLCommands.TextWrite(5, 20, EasyGest.Print.ElementDrawRotation.NO_ROTATION, EasyGest.Print.EPLFont.STANDARD_NORMAL,
                1, 1, false, "0", p));
            res.AddRange(EPLCommands.LineWriteBlack(5, 40, 1, 20, p));
            res.AddRange(EPLCommands.TextWrite(10, 40, EasyGest.Print.ElementDrawRotation.NO_ROTATION, EasyGest.Print.EPLFont.STANDARD_NORMAL,
                1, 1, false, "5", p));
            res.AddRange(EPLCommands.LineWriteBlack(10, 60, 1, 20, p));
            res.AddRange(EPLCommands.TextWrite(15, 60, EasyGest.Print.ElementDrawRotation.NO_ROTATION, EasyGest.Print.EPLFont.STANDARD_NORMAL,
                1, 1, false, "10", p));
            res.AddRange(EPLCommands.LineWriteBlack(15, 80, 1, 20, p));
            res.AddRange(EPLCommands.TextWrite(20, 80, EasyGest.Print.ElementDrawRotation.NO_ROTATION, EasyGest.Print.EPLFont.STANDARD_NORMAL,
                1, 1, false, "15", p));
            res.AddRange(EPLCommands.LineWriteBlack(20, 100, 1, 20, p));
            res.AddRange(EPLCommands.TextWrite(25, 100, EasyGest.Print.ElementDrawRotation.NO_ROTATION, EasyGest.Print.EPLFont.STANDARD_NORMAL,
                1, 1, false, "20", p));

            res.AddRange(EPLCommands.LineWriteBlack(40, 0, 20, 1, p));
            res.AddRange(EPLCommands.TextWrite(40, 5, EasyGest.Print.ElementDrawRotation.NO_ROTATION, EasyGest.Print.EPLFont.STANDARD_NORMAL,
                1, 1, false, "0", p));
            res.AddRange(EPLCommands.LineWriteBlack(60, 5, 20, 1, p));
            res.AddRange(EPLCommands.TextWrite(60, 10, EasyGest.Print.ElementDrawRotation.NO_ROTATION, EasyGest.Print.EPLFont.STANDARD_NORMAL,
                1, 1, false, "5", p));
            res.AddRange(EPLCommands.LineWriteBlack(80, 10, 20, 1, p));
            res.AddRange(EPLCommands.TextWrite(80, 15, EasyGest.Print.ElementDrawRotation.NO_ROTATION, EasyGest.Print.EPLFont.STANDARD_NORMAL,
                1, 1, false, "10", p));
            res.AddRange(EPLCommands.LineWriteBlack(100, 15, 20, 1, p));
            res.AddRange(EPLCommands.TextWrite(100, 20, EasyGest.Print.ElementDrawRotation.NO_ROTATION, EasyGest.Print.EPLFont.STANDARD_NORMAL,
                1, 1, false, "15", p));
            res.AddRange(EPLCommands.LineWriteBlack(120, 20, 20, 1, p));
            res.AddRange(EPLCommands.TextWrite(120, 25, EasyGest.Print.ElementDrawRotation.NO_ROTATION, EasyGest.Print.EPLFont.STANDARD_NORMAL,
                1, 1, false, "20", p));

            res.AddRange(EPLCommands.LineWriteBlack(p.Height, 20, 1, 20, p));
            res.AddRange(EPLCommands.LineWriteBlack(p.Height - 5, 40, 1, 20, p));
            res.AddRange(EPLCommands.LineWriteBlack(p.Height - 10, 60, 1, 20, p));
            res.AddRange(EPLCommands.LineWriteBlack(p.Height - 15, 80, 1, 20, p));
            res.AddRange(EPLCommands.LineWriteBlack(p.Height - 20, 100, 1, 20, p));

            res.AddRange(EPLCommands.LineWriteBlack(40, p.Width, 20, 1, p));
            res.AddRange(EPLCommands.LineWriteBlack(60, p.Width - 5, 20, 1, p));
            res.AddRange(EPLCommands.LineWriteBlack(80, p.Width - 10, 20, 1, p));
            res.AddRange(EPLCommands.LineWriteBlack(100, p.Width - 15, 20, 1, p));
            res.AddRange(EPLCommands.LineWriteBlack(120, p.Width - 20, 20, 1, p));
