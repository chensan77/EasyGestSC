...
Namespace Presentacion.Formulario
    ...
    Public Class frmBuscador
                ...
                Case ObjetoBusqueda.Producto
                    Using control As New VistasController(Of VWProductos)()
                        If ejecucionDirecta Then
                            e.Result = control.ExecuteCMD(_filtro)
                        Else
        ...
        Private Sub frmBuscador_Load(sender As Object, e As EventArgs) Handles Me.Load
            ...
            Select Case _objetoABuscar
                Case ObjetoBusqueda.Producto
                    ...
                    _expresionBusqueda = "(Activo = True) AND (Referencia.Contains(""{0}"") OR Descripcion.Contains(""{0}""))"
                ...
                Case ObjetoBusqueda.Cliente
                    ...
                    _expresionBusqueda = "(Activo = True) AND (Nombre.Contains(""{0}"") OR NombreCN.Contains(""{0}"") OR Identificacion.Contains(""{0}""))"
        ...
        Private Sub frmBuscador_KeyUp(sender As Object, e As KeyEventArgs) Handles Me.KeyUp
        ...
        Private Sub txtValor_KeyPress(sender As Object, e As KeyPressEventArgs) Handles txtValor.KeyPress
            If e.KeyChar = vbCr Then e.Handled = False
        End Sub
