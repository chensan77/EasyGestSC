...
Module modVarios
    ...
    <System.Runtime.CompilerServices.Extension()> _
    Public Function PascalCase(ByVal str As String) As String
        ...
        Else
            ...
            For Each parte As String In partes
                Dim caracteres As Char() = parte.ToLower().ToCharArray()
                caracteres(0) = (New String(caracteres(0), 1).ToUpper().ToCharArray()).First
